...
/// @brief Luapp 用の名前空間の開始
#define BEGIN_NAMESPACE_LUAPP \
BEGIN_NAMESPACE_YM \
BEGIN_NAMESPACE(nsLuapp)

/// @brief Luapp 用の名前空間の終了
#define END_NAMESPACE_LUAPP \
END_NAMESPACE(nsLuapp) \
END_NAMESPACE_YM
...
//////////////////////////////////////////////////////////////////////
/// @class Luapp Luapp.h "ym/Luapp.h"
...
public:
  ...
  void
  reg_metatable(
    const char* signature,     ///< [in] シグネチャ
    lua_CFunction gc_func,     ///< [in] GC用の関数
